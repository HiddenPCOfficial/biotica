...
import type { StructureCatalog } from '../structures/StructureCatalog'
import type { StructureInstance, StructureSystem } from '../structures/StructureSystem'

export type StructureRenderBounds = TileBounds
